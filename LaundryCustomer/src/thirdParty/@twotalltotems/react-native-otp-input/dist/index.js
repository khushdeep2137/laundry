...
export default class OTPInputView extends Component {
    constructor(props) {
        ...
        this.handleKeyboardDidHide = () => {
            ...
            this.setState({
                selectedIndex: this.state.digits.length - 1
            });
        };
        ...
        this.renderOneInputField = (_, index) => {
            ...
            return (<View pointerEvents="none" key={index + "view"} testID="inputSlotView">
                <TextInput testID="textInput" underlineColorAndroid='rgba(0,0,0,0)' style={selectedIndex === index ? { borderWidth: 0, borderColor: 'white' } : (selectedIndex > index) ? [defaultTextFieldStyle, codeInputFieldStyle, { borderWidth: 0, borderColor: 'white' }] : [defaultTextFieldStyle, codeInputFieldStyle]} ref={ref => { this.fields[index] = ref; }} onChangeText={text => {
                    this.handleChangeText(index, text);
